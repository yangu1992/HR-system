...
namespace NI.Application.HR.HRBase.Controllers.HeadCountController
{
    public class HeadCountController : Controller
    {
        ...
        public ActionResult Search(HeadCountSearchModel model) {
            ...
            return View("/Views/HeadCountActivity/HeadCountSearch.cshtml",model);
        }
        ...
        public ActionResult Create()
        {
            ...
            return View("/Views/HeadCountActivity/HeadCountCreate.cshtml");
        }

        [HttpPost]
        public ActionResult Create(HeadCount headcount)
        {
            Table_Headcount tmp = this.HeadCountService.AddHeadCount(headcount);
        ...
        public ActionResult ShowDetail(string CreateBtn, int? HeadcountCode, int? Page)
        {
            ...
            return View("/Views/HeadCountActivity/HeadCountDetail.cshtml", HcDetail);
        }
